...
import io.github.apwlq.octagon.databinding.OpenMoaImeBinding
import io.github.apwlq.octagon.hangul.HangulAssembler
import io.github.apwlq.octagon.view.keyboardview.*
import io.github.apwlq.octagon.view.keyboardview.qwerty.QuertyView
...
class OctagonIME : InputMethodService(), KoinComponent {
    ...
    override fun onCreateInputView(): View {
        ...
        window.window?.apply {
            navigationBarColor =
                ContextCompat.getColor(this@OctagonIME, R.color.keyboard_background)
    ...
    override fun onCreateInlineSuggestionsRequest(uiExtras: Bundle): InlineSuggestionsRequest {
        ...
        val foregroundColor = ContextCompat.getColor(this@OctagonIME, R.color.key_foreground)
