...
import io.github.apwlq.octagon.databinding.OpenMoaViewBinding
import io.github.apwlq.octagon.view.keytouchlistener.CrossKeyTouchListener
import io.github.apwlq.octagon.view.keytouchlistener.JaumKeyTouchListener
    ...
    private fun sendKeyMessage(keyMessage: StringKeyMessage) {
        broadcastManager.sendBroadcast(
            Intent(OctagonIME.INTENT_ACTION).apply {
                putExtra(OctagonIME.EXTRA_NAME, keyMessage.key)
            }
        )
    }
